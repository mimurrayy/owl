...
class vdW():
    ...
    def hydrogen_profile(self,x,T,n):
        ...
        if round(self.transition.wl, 0) == 656:
            ...
            #[Aik, wl, Eu, El, lu, ll]
            components = [
            [2.2448e-01, 656.2724, 12.087507, 10.19881, 1, 0],
            [2.2449e-01, 656.2771, 12.08749, 10.19881, 1, 0],

            [4.2097e-02, 656.2909, 12.087495, 10.19885, 0, 1],
            [2.1046e-02, 656.2752, 12.087495, 10.198806, 0, 1],

            [6.4651e-01, 656.2852, 12.08751, 10.19885, 0, 1],
            [5.3877e-01, 656.2701, 12.087507, 10.198806, 2, 1],
            [1.0775e-01, 656.2868, 12.087507, 10.19885, 2, 1]]
